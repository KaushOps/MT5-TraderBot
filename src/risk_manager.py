...
class RiskManager:
    ...
    def __init__(self, mt5_api=None):
        ...
        self.tp_atr_mult_min = float(CONFIG.get("tp_atr_mult_min") or 1.5)
        self.tp_atr_mult_max = float(CONFIG.get("tp_atr_mult_max") or 3.0)
        self.sl_atr_mult_min = float(CONFIG.get("sl_atr_mult_min") or 1.2)
        self.sl_atr_mult_max = float(CONFIG.get("sl_atr_mult_max") or 2.0)
        self.min_rr = float(CONFIG.get("min_rr") or 1.5)
        self.max_rr = float(CONFIG.get("max_rr") or 3.5)
        self.default_sl_atr_mult = float(CONFIG.get("default_sl_atr_mult") or 1.2)
        self.default_tp_atr_mult = float(CONFIG.get("default_tp_atr_mult") or 2.0)
